...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\livewire\Bookworm\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\my_projects\\livewire\\Bookworm\\public\\storage','logging.default','logging.deprecations.channel',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','wire-spy.enabled','wire-spy.keybinding',
...
'debugbar.assets.js','debugbar.cache.delete','debugbar.queries.explain','livewire.update','livewire.upload-file','livewire.preview-file',
'dashboard','profile','register','login','password.request',
...
'wire-spy::navbar','wire-spy::tabs.components','wire-spy::tabs.events','wire-spy::tabs.hot-reload','wire-spy::tabs.requests',
'wire-spy::toolbar',);
